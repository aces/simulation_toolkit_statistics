...
% NOTE 1: before running code, you must have access to the
%         CIVET_TaskForce_2016 directory thru ace_mount in your home directory
%
% NOTE 2: Four cubic ROIs are selected and the deformation are applied in
...
%% Main Function
function sta=sta_august19_momid(pipelinen, csv_filename, meter, sm_fwhm, ptv, ttv, c_centre, roi_right, roi_left,output_folder,roi_size)
close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
